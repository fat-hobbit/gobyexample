...
// RateLimitingDemo - demonstrates rate limiting in Go with
// goroutines, channels, and tickers
func RateLimitingDemo() {
	// Basic rate limiting: suppose we want to limit our
	// handling of incoming requests. We'll serve these
	...
	// request, we limit ourselves to 1 request every 200ms.
